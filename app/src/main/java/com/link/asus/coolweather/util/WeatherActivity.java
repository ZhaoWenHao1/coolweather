...
import com.link.asus.coolweather.gson.Forecast;
import com.link.asus.coolweather.gson.Weather;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "http://goulin.tech/api/weather?cityid=" + weatherId
                +"&key=08e0680ca77a4428b56e4ed95101f9e8";
